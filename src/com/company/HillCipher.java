...
class HillCipher{
    ...
    static ArrayList<ArrayList<Double>> convertKeyStringToMatrix(String key) {
    ...
    static Boolean isKeyValid(String plainText, String key) {
    ...
    static ArrayList<ArrayList<Double>> convertTextStringToMatrix(String text, String key) {
    ...
    static ArrayList<ArrayList<Double>> multiplyMatrices(ArrayList<ArrayList<Double>> firstMatrixArraylist, ArrayList<ArrayList<Double>> secondMatrixArraylist) {
    ...
    static String decrypt(ArrayList<ArrayList<Double>> cipherTextMatrixArrayList, String key) {
        String plainText;
